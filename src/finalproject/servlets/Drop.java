...
@WebServlet("/final-validate-drop")
public class Drop extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (courseService.delCourse(ssn, courseID)) {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher(URLHolder.ERROR_DROP.getUrl());
